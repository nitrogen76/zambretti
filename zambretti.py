...
## Pulled this out of https://github.com/nitrogen76/cheapWeather
## in case anyone wants it.

## you can use it standalone or as a module
## its kind of in rough shape but most additional work
## will be done in cheapWeather with this only getting
## major updates
